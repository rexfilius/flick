...
part of 'entity_tv.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class EntityTvAdapter extends TypeAdapter<EntityTv> {
  @override
  final int typeId = 2;

  @override
  EntityTv read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, EntityTv obj) {
    writer
      ..writeByte(12)
      ..writeByte(0)
